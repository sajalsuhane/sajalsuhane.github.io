      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Senior Software Engineer specializing in distributed systems, cloud architecture, and fintech innovation.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a
                  href="https://www.ijeat.org/wp-content/uploads/papers/v9i3/C5342029320.pdf"
                  target="_blank"
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            &copy; {currentYear} Sajal Suhane. All rights reserved.
          </p>
          <p className="text-gray-500 text-sm">
